                        ...
                        <div className="navbar-nav ms-auto text-uppercase fw-bold">
                            ...
                            <div className="dropdown">
                                ...
                                <ul className="dropdown-menu fw-bold text-capitalize">
                                    ...
                                    <li><Link className="dropdown-item" href="/category/mother-board">Motherboard</Link></li>
                            ...
                            <Link className="btn btn-warning fw-bold pb-2 mb-1 mx-2" href="/build">PC Builder</Link>
                            {
                                session?.user ?
                                    <button className="btn btn-danger fw-bold text-uppercase pb-2 mb-1 mx-2" onClick={logout}>Logout</button> :
