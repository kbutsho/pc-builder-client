                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div className="navbar-nav ms-auto text-uppercase fw-bold">
                            ...
                            <Link className="btn btn-warning fw-bold pb-2 mx-3 mb-1 navbar-btn" href="/build">Build PC</Link>
                            {
                                session?.user ?
                                    <button className="btn btn-danger fw-bold text-uppercase navbar-btn" onClick={logout}>Logout</button> :
