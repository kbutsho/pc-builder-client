...
const MotherBoardCard = (params) => {
    const { name, image, category, status, price, averageRating, id } = params.motherboard
    return (
        <div className='col-lg-2 col-12'>
            <div className='card'>
                ...
                <Link href={`/category/mother-board/${id}`} className='btn btn-primary btn-sm w-100 fw-bold'>details</Link>
            </div>
        </div>
    );
};
